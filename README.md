...
8. **Top 3 Products per Category**  
  ...
  ![](images/top3mostpurchasesproductswithineachcategory.png)

9. **Revenue by Age Group**  
    Calculated the total revenue contribution of each age group.

    ![](images/revenuecontributionofeachagegroup.png)
